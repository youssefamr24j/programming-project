...
public:
	...
	void DrawRhombus(Point P, GfxInfo TriGfxInfo, bool selected) const; //Draw Rhombus
	void DrawEll(Point P1, Point P2, GfxInfo GfxInfo, bool selected) const; //Draw Ellipse
